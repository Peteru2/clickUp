...
const TeamsImg = () => {
    ...
    <section className="bg-gray-100  md:bg-transparent rounded-lg md:p-0 p-5 mt-10">
        ...
        <div className="md:bg-rose-50 bg-transparent mt-10 rounded-md p-4">
            <div className="flex">
                <h3 className="mx-4 font-bold">Project & Tasks</h3>
                <h3 className="mx-4 font-bold">Chat</h3>
                <h3 className="mx-4 font-bold">Goals</h3>
                <h3 className="mx-4 font-bold">Views</h3>
            </div>

            <div className="grid md:grid-cols-2 grid-col-1 bg-rose-50 md:order-1 order-2 rounded-lg md:transparent my-4">
                <div className="p-4">
